...
echo  - To run only the playit proxy, Type "runproxy" ::OPTIONAL
...
set /p option1= [%username%@runit]~ ::OPTIONAL
if %option1% == configarea goto configarea ::OPTIONAL
...
set /p option1= [%username%]~ ::OPTIONAL
if %option1% == configarea goto configarea ::OPTIONAL
if %option1% == mainarea goto mainarea ::OPTIONAL
if %option1% == runarea goto runarea ::OPTIONAL
if %option1% == runall goto runall ::OPTIONAL
