...
1- Make sure to rename the (server software).jar file in your server's folder to a more simple name. (Eg. "arclight-forge-1.19.3-1.0.2.jar" -> "arclight.jar")
   You can find a list of java server software, by me, here: https://telegra.ph/MCrunit-07-10
